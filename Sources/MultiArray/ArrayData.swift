...
extension Unit: ArrayData {
    ...
    @inlinable
    public static func initialise(_: Self.Buffer, at _: Int, to _: Self) {}

    @inlinable
    public static func deinitialise(_: Self.Buffer, count _: Int) {}
    ...
    @inlinable
    // @_alwaysEmitIntoClient
    public static func write(_: Self.Buffer, at _: Int, to _: Self) {}
