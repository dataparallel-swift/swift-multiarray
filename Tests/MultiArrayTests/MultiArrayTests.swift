...
struct MultiArrayTests {
    ...
    struct DataTests {
        ...
        func failMagic() throws {
            ...
            #expect(throws: MultiArrayBinaryError.badMagic) {
        ...
        func failVersion() throws {
            ...
            #expect(throws: MultiArrayBinaryError.unsupportedVersion(99)) {
                _ = try MultiArray<Int>(data: encoded)
            }
        }
        ...
        func failTruncated() throws {
            ...
            #expect(throws: MultiArrayBinaryError.truncated) {
        ...
        func failCountMismatch() throws {
            ...
            encoded[8] ^= 0x01
            #expect(throws: MultiArrayBinaryError.self) {
                _ = try MultiArray<Int32>(data: encoded)
            }
        }

        @Test
        func failByteCountMismatch() throws {
            let array: MultiArray<Int32> = [10, 20, 30]
            var encoded = array.encode()

            // byteCount field offset (16 .. <24)
            let byteCount = encoded.withUnsafeBytes { $0.load(fromByteOffset: 16, as: UInt64.self) }
            #expect(byteCount == 12)
        ...
        @Test
        func failSizeMismatch() throws {
            let array: MultiArray<Int32> = [1, 2, 3]
            let encoded = array.encode()

            #expect(throws: MultiArrayBinaryError.sizeMismatch(expected: 24, actual: 12)) {
